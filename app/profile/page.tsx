...
const UserProfile = () => {
  ...
  // 1754768747064-running%2520man%2520macau.jpg
  // 1754768747064-running%20man%20macau.jpg
  // 1754771448233-running%20man%20macau.jpg
  ...
  return (
    <div className="flex flex-row ml-64 min-h-screen">
      ...
      <div className="font-sans flex flex-col p-8 pb-20 gap-8 sm:p-20 w-full ">
        ...
        <div className="">
          <div className="hero ">
            <div className="hero-content flex-col w-full bg-base-100">
              {/* Cover Image */}
              <div
                className="w-full h-80 bg-cover object-cover bg-center relative"
                style={{
                  backgroundImage: coverImage
                    ? `url('${firestoreUser?.coverImage}')`
                    : `url('${firestoreUser?.photoURL}')`,
                }}
              >
                {editToggle && (
              ...
              <div className="flex flex-col w-full gap-4 pl-12">
                <div className="flex flex-row">
                  ...
                  <h1 className="text-2xl pt-8 wrap">
                ...
                {editToggle ? (
                  <div>
                    <textarea
                      ...
                      placeholder="Bio"
                      defaultValue={firestoreUser?.bio}
